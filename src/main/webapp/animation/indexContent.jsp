...
<script>
    ...
    const inputString = `
    PH_0 [ T ][ T ][ T ][ T ][ T ][ T ][ T ][ B ][ B ][PUL][ B ][PUR][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][PDL][PDR][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][PUL][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][PUR][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][PDL][ B ][PDR][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][PUL][ B ][ B ][ B ][ B ][ B ][PUR][ E ][ E ][ E ][ E ][ E ][ E ]
PH_1 [ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][PUL][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][PUR][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ B ][PDL][ B ][PDR][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][PUL][ B ][ B ][ B ][PUR][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][PDL][ B ][PDR][ T ][ T ][ T ][ T ][ T ]
PH_2 [ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][PUL][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][PUR][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ B ][PDL][ B ][PDR][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ B ][ B ][ B ][ B ][PUL][ B ][ B ][ B ][PUR][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][PDL][ B ][PDR][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ B ][ B ][ B ][ B ][ B ][ B ][PUL][ B ][ B ][PUR][ E ]
PH_3 [ T ][ T ][ T ][ T ][ T ][ B ][ B ][ B ][ B ][PUL][ B ][PUR][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][PDL][ B ][PDR][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][PUL][ B ][ B ][PUR][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][PDL][ B ][PDR][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ B ][ B ][ B ][ B ][PUL][ B ][ B ][ B ][ B ][ B ][ B ][PUR][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][PDL][PDR][ T ][ T ]
PH_4 [ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][PUL][PUR][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ B ][PDL][ B ][PDR][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][ T ][PUL][ B ][ B ][ B ][ B ][ B ][PUR][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][ E ][PDL][PDR][ T ][ T ][ T ][ T ][ T ][ T ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][ B ][PUL]
    ...
    function animatePhilosophers() {
        ...
        const interval = setInterval(() => {
            ...
            timeStep++;
        }, 200); // Change the step time as needed
    }
