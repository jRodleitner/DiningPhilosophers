...
<div class="description">
    ...
    <img src="../pictures/resource.svg" alt="Dining Philosophers Problem" width="400" height="350">
</div>
<h2>Asymmetric Solution</h2>
<div class="description">
    <p>The Token Solution </p>
    <img src="../pictures/asymmetric.svg" alt="Dining Philosophers Problem" width="400" height="350">
</div>
</body>
</html>
